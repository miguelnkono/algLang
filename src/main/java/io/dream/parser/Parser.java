...
public class Parser
{
  ...
  {
    // variables: name : entier;
    // variables: name : entier = "miguel";
    Token name = consume(IDENTIFIER, "en attente du name de votre variable");
    consume(COLON, "manque de deux point \":\" après votre variable");
    ...
    consume(COMMA, "manque de point virgule à la fin de la déclaration de votre variable");
